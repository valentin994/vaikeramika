...
<div class="grid grid-cols-1 md:grid-cols-3 mb-12 md:gap-4 w-full md:grid-row-1 px-4 md:px-24 lg:px-52">
	<div
		class="flex border border-gray-300 rounded-md shadow-md w-full p-4 py-8 my-4 justify-between items-center bg-gray-300 bg-opacity-25"
	>
		<img alt="House" src="./house2.svg" class="w-16" />
		<h2 class="text-gray-500 p-4">Odradeno vise od 1000 domova.</h2>
	</div>
	<div
		class="flex border border-gray-300 rounded-md shadow-md p-4 py-8 my-4 justify-between items-center bg-gray-300 bg-opacity-25"
	>
