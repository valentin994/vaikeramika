...
<div class="max-w-xs w-full mt-8">
  <form class="bg-gray-300 bg-opacity-25 border border-gray-200 shadow-md rounded-md px-8 pt-6 pb-8 mb-4">
    ...
    <div class="mb-6">
      ...
      <textarea class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline focus:outline-secondary" id="poruka"></textarea>
    </div>
